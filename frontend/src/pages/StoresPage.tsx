  ...
  const deleteMutation = useMutation({
    ...
    onError: (error: any) => {
      ...
      const hasPurchaseOrders =
        backendMessage.includes('purchase order') ||
        backendMessage.includes('associated purchase orders');
      ...
      if (hasPurchaseOrders || referentialIntegrityConflict) {
        setDeleteError(
          'Delete failed. This store is still referenced by one or more purchase orders. Reassign or remove the linked purchase orders first, then try again.'
        );
        return;
      }
