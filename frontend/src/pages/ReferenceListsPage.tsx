...
const REFERENCE_LISTS: ReferenceListConfig[] = [
  ...
  },
  {
    ...
    nameColumn: 'ConditionTypeName',
    nameLabel: 'Condition Type Name',
    namePlaceholder: 'Enter condition type name',
    newButtonLabel: 'Add Condition Type',
    newTitle: 'Add Condition Type',
    editTitle: 'Edit Condition Type',
    ...
    fields: [
      { key: 'ConditionTypeDescription', label: 'Condition Description', placeholder: 'Enter condition description', type: 'textarea', required: false },
    ],
  },
  {
    key: 'stores',
